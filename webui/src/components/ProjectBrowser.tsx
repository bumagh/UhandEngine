  ...
  const projectStructure: FileNode[] = [
    {
      ...
      children: [
        { name: 'engine', type: 'folder', children: [
          { name: 'Scene.c', type: 'file' },
          { name: 'GameObject.c', type: 'file' },
          { name: 'Transform.c', type: 'file' },
          { name: 'Component.c', type: 'file' },
        ]},
        { name: 'examples', type: 'folder', children: [
          { name: 'game_example.c', type: 'file' },
          { name: 'platformer_example.c', type: 'file' },
          { name: 'shooter_example.c', type: 'file' },
        ]},
      ]
    },
    {
      ...
      children: [
        ...
        { name: 'ai-workflow-design.md', type: 'file' },
      ]
    },
    {
      name: 'README.md',
